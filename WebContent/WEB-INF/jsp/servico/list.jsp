		...
		<div id="page-content">
			<div id="wrap">
				<div id="page-heading">
					...
					<h1>Serviço</h1>
					<div class="options">
						<a href='<c:url value="/servico/form"/>'class="btn btn-warning">Incluir</a>
					</div>
				</div>
										...
										<div class="row">
											<div class="col-xs-3 col-xs-offset-9">
												<div class="dataTables_filter" id="example_filter">
													<form action="<c:url value='/servico/list'/>" method="post" id="form_filtro">
														<div class="input-group">
															<input type="text" aria-controls="example"
																class="form-control" placeholder="Pesquisar..." name="filtro"
																value="${filtro}">
															<div class="input-group-btn">
																<a href="javascript: $('#form_filtro').submit();" class="btn btn-warning"><i class="fa fa-search"></i></a>
															</div>
														</div>
													</form>
												</div>
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" role="columnheader" tabindex="0"
														...
														style="width: 265px;">Nome</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="Browser: activate to sort column ascending"
														style="width: 265px;">Valor</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="CSS grade: activate to sort column ascending"
														style="width: 90px;">Opções</th>
												</tr>
											</thead>
											...
											<tbody role="alert" aria-live="polite" aria-relevant="all">
												<c:forEach items="${servicoList}" var="servico">
													<tr class="gradeA">
														...
														<td class=" sorting_1">${servico.id}</td>
														<td class=" ">${servico.nome}</td>
														<td class=" ">R$ <fmt:formatNumber minFractionDigits="2" value="${servico.valor}"/></td>
														<td class="center "><a
															href="<c:url value='/servico/form?servico.id=${servico.id}'/>"
															class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Editar</a> <a
															href="<c:url value='/servico/delete?servico.id=${servico.id}'/>"
