				...
				<div id="page-heading">
					...
					<div class="options">
						<div class="btn-toolbar">
							<a href="<c:url value='/convenio/form'/>" class='btn btn-purple'>Incluir</a>
						</div>
					</div>
				</div>
										...
										<div class="row">
											<div class="col-xs-3 col-xs-offset-9">
												<div class="dataTables_filter" id="example_filter">
													<form action="<c:url value='/convenio/list'/>" method="post" id="form_filtro">
														<div class="input-group">
															<input type="text" aria-controls="example"
																class="form-control" placeholder="Pesquisar..." name="filtro"
																value="${filtro}">
															<div class="input-group-btn">
																<a href="javascript: $('#form_filtro').submit();" class="btn btn-purple"><i class="fa fa-search"></i></a>
															</div>
														</div>
													</form>
												</div>
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" role="columnheader" tabindex="0"
														...
														style="width: 375px;">Razão Social</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="Engine version: activate to sort column ascending"
														style="width: 250px;">Telefone</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
											...
											<tbody role="alert" aria-live="polite" aria-relevant="all">
												<c:forEach items="${convenioList}" var="convenio">
													<tr class="gradeA">
														...
														<td class=" sorting_1">${convenio.id}</td>
														<td class=" ">${convenio.nome}</td>
														<td class="center">${convenio.telefone}</td>
														<td class="center "><a
															href="<c:url value='/convenio/form?convenio.id=${convenio.id}'/>"
															class="btn btn-default btn-purple btn-xs"><i class="fa fa-edit"></i> Editar</a> <a
															href="<c:url value='/convenio/delete?convenio.id=${convenio.id}'/>"
