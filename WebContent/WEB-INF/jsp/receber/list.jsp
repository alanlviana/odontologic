		...
		<div id="page-content">
			<div id="wrap">
				<div id="page-heading">
					<ol class="breadcrumb">
						<li>Listagem</a></li>
						<li class="active">Conta a Receber</li>
					</ol>

					<h1>Conta a Receber</h1>
					<!--<div class="options">
						<div class="btn-toolbar">
							<a href="<c:url value='/odontologo/form'/>" class='btn btn-alizarin'>Incluir</a>
						</div>
					</div> -->
				</div>
										...
										<div class="row">
											<div class="col-xs-3 col-xs-offset-9">
												<div class="dataTables_filter" id="example_filter">
													<form action="<c:url value='/receber/list'/>" method="post" id="form_filtro">
														<div class="input-group">
															<input type="text" aria-controls="example"
																class="form-control" placeholder="Pesquisar..." name="filtro"
																value="${filtro}">
															<div class="input-group-btn">
																<a href="javascript: $('#form_filtro').submit();" class="btn btn-inverse"><i class="fa fa-search"></i></a>
															</div>
														</div>
													</form>
												</div>
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" role="columnheader" tabindex="0"
														...
														style="width: 275px;">Nome do Paciente</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="Platform(s): activate to sort column ascending"
														style="width: 180px;">Vencimento</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="Engine version: activate to sort column ascending"
														style="width: 125px;">Valor</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="CSS grade: activate to sort column ascending"
														style="width: 120px;">Opções</th>
												</tr>
											</thead>

											<tbody role="alert" aria-live="polite" aria-relevant="all">
												<c:forEach items="${receberList}" var="receber">
													<tr class="gradeA">

														<td class=" sorting_1">${receber.id}</td>
														<td class=" ">${receber.paciente.nome}</td>
														<td class=" "> <fmt:formatDate value="${receber.dataVencimento}" pattern="dd/MM/yyyy" /> </td>
														<td class="center ">R$ <fmt:formatNumber minFractionDigits="2" value="${receber.valorTotal}"/></td>
														<td class="center "><a
															href="<c:url value='/receber/detail?receber.id=${receber.id}'/>"
															class="btn btn-default btn-inverse btn-xs"><i class="fa fa-edit"></i> Detalhar</a></td>
