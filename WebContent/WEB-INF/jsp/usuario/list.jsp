				...
				<div id="page-heading">
					...
					<div class="options">
						<div class="btn-toolbar">
							<a href="<c:url value='/usuario/form'/>" class="btn btn-brown">Incluir</a>
						</div>
					</div>
				</div>
										...
										<div class="row">
											<div class="col-xs-3 col-xs-offset-9">
												<div class="dataTables_filter" id="example_filter">
													<form action="<c:url value='/usuario/list'/>" method="post" id="form_filtro">
														<div class="input-group">
															<input type="text" aria-controls="example"
																class="form-control" placeholder="Pesquisar..." name="filtro"
																value="${filtro}">
															<div class="input-group-btn">
																<a href="javascript: $('#form_filtro').submit();" class="btn btn-brown"><i class="fa fa-search"></i></a>
															</div>
														</div>
													</form>
												</div>
											...
											<thead>
												<tr role="row">
													<th class="sorting_asc" role="columnheader" tabindex="0"
														...
														style="width: 125px;">Código</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="Browser: activate to sort column ascending"
														style="width: 275px;">Nome de Usuário</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="Browser: activate to sort column ascending"
														style="width: 260px;">Nome</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
											...
											<tbody role="alert" aria-live="polite" aria-relevant="all">
												<c:forEach items="${usuarioList}" var="usuario">
													<tr class="gradeA">
														...
														<td class=" ">${usuario.nomeUsuario}</td>
														<td class=" ">${usuario.nome}</td>
														<td class="center "><a
															href="<c:url value='/usuario/form?usuario.id=${usuario.id}'/>"
															class="btn btn-brown btn-xs"><i class="fa fa-edit"></i> Editar</a> <a
															href="<c:url value='/usuario/delete?usuario.id=${usuario.id}'/>"
