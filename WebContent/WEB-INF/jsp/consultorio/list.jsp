				...
				<div id="page-heading">
					...
					<div class="options">
						<div class="btn-toolbar">
							<div class="col-xs-9">
									<a href="<c:url value='/consultorio/form'/>" class='btn btn-indigo'>Incluir</a>
							</div>
						</div>
					</div>
				</div>
										...
										<div class="row">
											<div class="col-xs-3 col-xs-offset-9">
												<div class="dataTables_filter" id="example_filter">
													<form action="<c:url value='/consultorio/list'/>" method="post" id="form_filtro">
														<div class="input-group">
															<input type="text" aria-controls="example"
																class="form-control" placeholder="Pesquisar..." name="filtro"
																value="${filtro}">
															<div class="input-group-btn">
																<a href="javascript: $('#form_filtro').submit();" class="btn btn-indigo"><i class="fa fa-search"></i></a>
															</div>
														</div>
													</form>
												</div>
										...
										<table cellpadding="0" cellspacing="0" border="0"
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" role="columnheader" tabindex="0"
														...
														style="width: 300px;">Descrição</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
											...
											<tbody role="alert" aria-live="polite" aria-relevant="all">
												<c:forEach items="${consultorioList}" var="consultorio">
													<tr class="gradeA">
														<td class=" sorting_1">${consultorio.id}</td>
														<td class=" ">${consultorio.descricao}</td>
														<td class="center "><a
															href="<c:url value='/consultorio/form?consultorio.id=${consultorio.id}'/>"
															class="btn btn-indigo btn-xs"><i class="fa fa-edit"></i> Editar</a> <a
															href="<c:url value='/consultorio/delete?consultorio.id=${consultorio.id}'/>"
