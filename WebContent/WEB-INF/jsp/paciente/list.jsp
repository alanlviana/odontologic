				...
				<div id="page-heading">
					...
					<div class="options">
						<div class="btn-toolbar">
							<a href="<c:url value='/paciente/form'/>" class='btn btn-info'>Incluir</a>
						</div>
					</div>
				</div>
										...
										<div class="row">
											<div class="col-xs-3 col-xs-offset-9">
												<div class="dataTables_filter" id="example_filter">
													<form action="<c:url value='/paciente/list'/>" method="post" id="form_filtro">
														<div class="input-group">
															<input type="text" aria-controls="example"
																class="form-control" placeholder="Pesquisar..." name="filtro"
																value="${filtro}">
															<div class="input-group-btn">
																<a href="javascript: $('#form_filtro').submit();" class="btn btn-info"><i class="fa fa-search"></i></a>
															</div>
														</div>
													</form>
												</div>
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" role="columnheader" tabindex="0"
														...
														style="width: 275px;">Nome</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
														aria-label="Platform(s): activate to sort column ascending"
														style="width: 225px;">CPF</th>
													<th class="sorting" role="columnheader" tabindex="0"
														aria-controls="example" rowspan="1" colspan="1"
											...
											<tbody role="alert" aria-live="polite" aria-relevant="all">
												<c:forEach items="${pacienteList}" var="paciente">
													<tr class="gradeA">
														...
														<td class=" "><c:out escapeXml="true" value="${paciente.nome}"></c:out></td>
														<td class=" ">${paciente.cpf}</td>
														<td class="center ">${paciente.telefoneCelular}</td>
														<td class="center "><a
															href="<c:url value='/paciente/form?paciente.id=${paciente.id}'/>"
															class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Editar</a> <a
															href="<c:url value='/paciente/delete?paciente.id=${paciente.id}'/>"
