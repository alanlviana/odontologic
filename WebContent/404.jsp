...
<body style="padding-top: 0px">
	...
	<div id='wrap'>
		<div id="page-heading">
			<ol class="breadcrumb">
				<li><a href="/NewOdontologic/">Dashboard</a></li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<p class="text-center">Se você sabe que não está louco e acha que tudo isso é uma grande conspiração,</br>clique para voltar para a <a href="/NewOdontologic/">dashboard</a>.</p>
				</div>
			</div>
